...
const responseContentTypeSchema = z.literal([
  ...
  // ========== BROWSER API TYPES (NOT IN OPENAPI/SWAGGER SPEC) ==========
  // not_supported - Browser Fetch API arrayBuffer() response
  'arrayBuffer',
  // not_supported - Browser Fetch API blob() response
  'blob',
  // not_supported - Browser Fetch API formData() response
  'formData',
  // not_supported - Browser Fetch API json() response (use application/json)
  'json',
  // not_supported - Browser Fetch API text() response (use text/plain)
  'text',
  // not_supported - Browser streaming API
  'stream',
]);
...
const requestContentTypeSchema = z.literal([
  ...
  // ========== BROWSER API TYPES (NOT IN OPENAPI/SWAGGER SPEC) ==========
  // not_supported - Browser FormData object
  'formData',
  // not_supported - Browser URLSearchParams object
  'urlSearchParams',
  // not_supported - Browser Blob object
  'blob',
  // not_supported - Browser ArrayBuffer object
  'arrayBuffer',
  // not_supported - Browser ReadableStream object
  'readableStream',
  // not_supported - Plain string body (use text/plain)
  'string',
]);
